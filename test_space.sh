...
./scripts/hf_text2image.py /work3/s243891/output/space \
    --prompt "prompts/space/space_img.txt" \
    -v

./scripts/hf_video2world.py output/hf_video2world \
    --prompt "prompts/space/space_vid.txt" \
    --image "/work3/s243891/output/space/output.png" \
    -v 